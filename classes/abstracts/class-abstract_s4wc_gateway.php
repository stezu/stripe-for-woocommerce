<?php
/**
 * Stripe Gateway Abstract
 *
 * Defines methods used for all gateways under this umbrella and simplifies the standard gateway class
 *
 * @class       Abstract_S4WC_Gateway
...
abstract class Abstract_S4WC_Gateway extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $icon_url = apply_filters( 's4wc_icon_url', plugins_url( 'assets/images/credits.png', dirname( dirname(__FILE__) ) ) );
        if ( $icon_url ) {
            $this->icon = $icon_url;
        }
    ...
    public function load_scripts() {
        ...
        // Plugin js
        wp_enqueue_script( 's4wc_js', plugins_url( 'assets/js/s4wc.min.js', dirname( __FILE__ ) ), array( 'stripe', 'wc-credit-card-form' ), '1.31', true );
